...
SECRET_KEY = 'django-insecure-)%fc#=w3#7nbx8dr#i31^crgg_n1c=&)x6lms^da5k@-tneh!9'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gateway_db',   # Tên database của riêng service này
        'USER': 'admin',         # Khớp với docker-compose
        'PASSWORD': '123',       # Khớp với docker-compose
        'HOST': 'postgres-db',   # Tên service Postgres trong docker-compose
        'PORT': '5432',
    }
}
